...
const ButtonGroupRoot = (0, _styled.default)('div', {
  ...
  return [(0, _extends2.default)({
  ...
  }, ownerState.color !== 'context' && (0, _extends2.default)({
    ...
    '--ButtonGroup-separatorColor': (_theme$vars$palette2 = theme.vars.palette[ownerState.color]) == null ? void 0 : _theme$vars$palette2[400]
  }), {
    ...
    [`& .${_buttonClasses.default.root}, & .${_iconButtonClasses.default.root}`]: (0, _extends2.default)({
    ...
    }, ownerState.color !== 'context' && ownerState.variant === 'outlined' && {
      '&:hover': {
      ...
      '&:disabled': {
        '--ButtonGroup-separatorColor': (_theme$vars$palette4 = theme.vars.palette[ownerState.color]) == null ? void 0 : _theme$vars$palette4.outlinedDisabledBorder
      }
    })
    ...
    [theme.getColorSchemeSelector('dark')]: (0, _extends2.default)({}, ownerState.color !== 'context' && (0, _extends2.default)({}, ownerState.variant !== 'outlined' && {
      '--ButtonGroup-separatorColor': (_theme$vars$palette5 = theme.vars.palette[ownerState.color]) == null ? void 0 : _theme$vars$palette5[700]
    }))
  }];
});
