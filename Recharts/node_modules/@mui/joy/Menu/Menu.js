...
const _excluded = ["actions", "anchorEl", "children", "color", "component", "disablePortal", "keepMounted", "invertedColors", "onClose", "onItemsChange", "open", "modifiers", "variant", "size", "slots", "slotProps"];
...
const Menu = /*#__PURE__*/React.forwardRef(function Menu(inProps, ref) {
  ...
  if (anchorEl && process.env.NODE_ENV !== 'production') {
    ...
    if ('getAttribute' in resolvedAnchorEl) {
      ...
      var _resolvedAnchorEl$con;
      ariaControls = (_resolvedAnchorEl$con = resolvedAnchorEl.contextElement) == null ? void 0 : _resolvedAnchorEl$con.getAttribute('aria-controls');
    }
    if (props.id && ariaControls && props.id !== ariaControls) {
      console.error(`MUI: the anchorEl must have [aria-controls="${props.id}"] but got [aria-controls="${ariaControls}"].`);
    }
  }
