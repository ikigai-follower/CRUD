...
const ButtonGroupRoot = styled('div', {
  ...
  return [_extends({
    ...
    [`& .${buttonClasses.root}, & .${iconButtonClasses.root}`]: _extends({
      ...
      '&:hover': {
        '--ButtonGroup-separatorColor': theme.vars.palette[ownerState.color]?.outlinedHoverBorder
      },
      '&:disabled': {
        '--ButtonGroup-separatorColor': theme.vars.palette[ownerState.color]?.outlinedDisabledBorder
      }
    })
